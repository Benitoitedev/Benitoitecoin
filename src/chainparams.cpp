...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1555587791, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 17115;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Benitoite starting difficulty is 1 / 2^12
        ...
        nMasternodeCollateralLimit = 20;
        nModifierUpdateBlock = 10600000; //fake stake update
        nMaxMoneyOut = 100000 * COIN;
        const char* pszTimestamp = "Benitoite coin - 2019";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1555587791;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 7146077;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000007806b92a7ef11b6451bf3ac569217654ffbcd1aaaaa864c8b540e04b8f2"));
        assert(genesis.hashMerkleRoot == uint256("0x06602a843d07cc2f3b4aeb97406400da9219a99c831147742fcadd7a6c29d7d6"));
        ...
        strSporkKey = "041eb486c627798c3597e25cf2d4a08e30e3e1111322d6fb25c2a0bbd7db12d43726bd89c32e77a3dd59d77a8b3660473aef8a3e2712215150b7df2f262499b534";
        strObfuscationPoolDummyAddress = "bJQHboDZUH8GmxpcQHHt7it3uwwahV2zs3";
        nStartMasternodePayments = 1555587791;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Benitoite: 1 day
        nTargetSpacing = 1 * 60;  // Benitoite: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet benitoite addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet benitoite script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet benitoite BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet benitoite BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet benitoite BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Benitoite: 1 day
        nTargetSpacing = 1 * 60;        // Benitoite: 1 minutes
