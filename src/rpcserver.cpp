...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Benitoite server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Benitoite server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Benitoite features */
        {"benitoite", "masternode", &masternode, true, true, false},
        {"benitoite", "listmasternodes", &listmasternodes, true, true, false},
        {"benitoite", "getmasternodecount", &getmasternodecount, true, true, false},
        {"benitoite", "masternodeconnect", &masternodeconnect, true, true, false},
        {"benitoite", "masternodecurrent", &masternodecurrent, true, true, false},
        {"benitoite", "masternodedebug", &masternodedebug, true, true, false},
        {"benitoite", "startmasternode", &startmasternode, true, true, false},
        {"benitoite", "createmasternodekey", &createmasternodekey, true, true, false},
        {"benitoite", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"benitoite", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"benitoite", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"benitoite", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"benitoite", "getmasternodescores", &getmasternodescores, true, true, false},
        {"benitoite", "mnbudget", &mnbudget, true, true, false},
        {"benitoite", "preparebudget", &preparebudget, true, true, false},
        {"benitoite", "submitbudget", &submitbudget, true, true, false},
        {"benitoite", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"benitoite", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"benitoite", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"benitoite", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"benitoite", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"benitoite", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"benitoite", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"benitoite", "checkbudgets", &checkbudgets, true, true, false},
        {"benitoite", "mnsync", &mnsync, true, true, false},
        {"benitoite", "spork", &spork, true, true, false},
        {"benitoite", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"benitoite", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use benitoited, or the -server option to benitoite-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> benitoite-cli " + methodname + " " + args + "\n";
}
