...
/** Utility functions used by the Benitoite Qt UI.
 */
namespace GUIUtil
{
...
// Render Benitoite addresses in monospace font
...
// Parse "benitoite:" URI into recipient object, return true on successful parsing
