...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Benitoite Core"),
     ...
     * override -datadir in the benitoite.conf file in the default data directory
     * (to be consistent with benitoited behavior)
     */
    if (dataDir != getDefaultDataDirectory())
