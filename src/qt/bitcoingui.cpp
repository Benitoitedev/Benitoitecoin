                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Benitoite Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Benitoite address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and benitoite: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Benitoite Core"), this);
    aboutAction->setStatusTip(tr("Show information about Benitoite Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Benitoite"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Benitoite addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Benitoite addresses"));
    ...
    openAction->setStatusTip(tr("Open a Benitoite: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Benitoite Core help message to get a list with possible Benitoite command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Benitoite Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Benitoite network", "", count));
}
...
{
    QString strTitle = tr("Benitoite Core"); // default title
