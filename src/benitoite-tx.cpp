...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Benitoite Core benitoite-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  benitoite-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded benitoite transaction") + "\n" +
                               "  benitoite-tx [options] -create [commands]   " + _("Create hex-encoded benitoite transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded benitoite transaction
