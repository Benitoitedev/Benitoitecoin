...
In order to support loading of multiple wallets in benitoite-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is benitoite.cpp.
...
Changes to benitoite.cpp
----------------------
benitoite.cpp is the entry point into benitoite-qt, and as such, will require some minor modifications to provide hooks for
